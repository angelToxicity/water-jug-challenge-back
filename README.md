...
## Code Explanation
- Visited set: Used to prevent visiting the same state multiple times and falling into an infinite loop.
- dfs function: Performs a depth-first search exploring all possible moves from a given state.
- Stopping conditions:
